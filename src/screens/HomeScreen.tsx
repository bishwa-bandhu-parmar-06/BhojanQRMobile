...
const Home = () => {
  ...
  const contactLinks = [
    ...
    { icon: "question-circle", text: "Help", action: () => navigation.navigate("Help") },
  ];
...
const styles = StyleSheet.create({
  ...
  sectionHeaderCenter: { alignItems: 'center', marginBottom: 16 },
  sectionHeader: { fontSize: 24, fontWeight: '900', color: '#166534', letterSpacing: -0.5 },
  processSubHeader: { color: '#ea580c', fontSize: 12, fontWeight: '800', letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 4 },
  premiumShadow: { ...Platform.select({ ios: { shadowColor: '#000', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.08, shadowRadius: 16 }, android: { elevation: 5 } }) },
  buttonShadow: { ...Platform.select({ ios: { shadowColor: '#ea580c', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 12 }, android: { elevation: 8, shadowColor: '#ea580c' } }) },
  heroSection: { paddingTop: 32, paddingHorizontal: 24, alignItems: 'center' },
  topBadge: { backgroundColor: '#ffffff', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 100, flexDirection: 'row', alignItems: 'center', marginBottom: 36 },
  badgeDot: { width: 8, height: 8, backgroundColor: '#16a34a', borderRadius: 4, marginRight: 10 },
  badgeText: { color: '#ea580c', fontSize: 13, fontWeight: '700', letterSpacing: 0.3 },
  titleContainer: { alignItems: 'center', marginBottom: 20 },
  titleGreen: { fontSize: 42, fontWeight: '900', color: '#166534', marginBottom: -4, letterSpacing: -1 },
  titleOrange: { fontSize: 42, fontWeight: '900', color: '#ea580c', letterSpacing: -1 },
  titleUnderline: { height: 4, width: 140, backgroundColor: '#ea580c', borderRadius: 4, marginTop: 12 },
  heroSubtext: { fontSize: 16, color: '#4b5563', fontWeight: '500', textAlign: 'center', lineHeight: 26, marginBottom: 16, paddingHorizontal: 10 },
  heroTagsContainer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 40 },
  heroTags: { fontSize: 12, color: '#9ca3af', fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
  tagDot: { width: 4, height: 4, backgroundColor: '#d1d5db', borderRadius: 2, marginHorizontal: 8 },
  statsWrapper: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', marginBottom: 40 },
  statColumn: { alignItems: 'center', flex: 1 },
  statDivider: { width: 1, height: 40, backgroundColor: 'rgba(0,0,0,0.06)' },
  statValue: { fontSize: 34, fontWeight: '900', color: '#166534', letterSpacing: -1 },
  statPlus: { fontSize: 24, color: '#16a34a' },
  statLabel: { fontSize: 11, color: '#6b7280', fontWeight: '700', marginTop: 4, textAlign: 'center', textTransform: 'uppercase', letterSpacing: 0.5 },
  ratingRow: { flexDirection: 'row', alignItems: 'center', marginTop: 14 },
  primaryButton: { width: '100%', backgroundColor: '#ea580c', paddingVertical: 18, borderRadius: 16, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' },
  primaryButtonText: { color: '#ffffff', fontSize: 18, fontWeight: '800', marginRight: 12, letterSpacing: 0.5 },
  secondaryButton: { marginTop: 24, backgroundColor: '#16a34a', paddingVertical: 18, borderRadius: 16, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' },
  secondaryButtonText: { color: '#ffffff', fontSize: 16, fontWeight: '700', marginLeft: 10, letterSpacing: 0.5 },
  horizontalScrollPadding: { paddingHorizontal: 24, paddingBottom: 24, paddingTop: 8 },
  cardContainer: { backgroundColor: '#ffffff', padding: 30, borderRadius: 28, marginRight: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.8)', alignItems: 'center' },
  iconBox: { width: 64, height: 64, borderRadius: 20, alignItems: 'center', justifyContent: 'center', marginBottom: 20 },
  cardTitle: { fontSize: 20, fontWeight: '800', color: '#111827', marginBottom: 10, textAlign: 'center' },
  cardDescription: { fontSize: 14, color: '#6b7280', lineHeight: 22, fontWeight: '500', textAlign: 'center' },
  contactWrapper: { paddingHorizontal: 24, paddingTop: 20, paddingBottom: 10 },
  contactCard: { backgroundColor: '#ffffff', borderRadius: 24, paddingVertical: 8 },
  contactRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 16, paddingHorizontal: 20 },
  contactBorder: { borderBottomWidth: 1, borderBottomColor: '#f3f4f6' },
  contactIconSquare: { backgroundColor: '#dcfce7', width: 40, height: 40, borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginRight: 16 },
